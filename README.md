...
But if you want to use this library on sbcl for windows immediately, version 0.2.1 is available. (This version has issue [#1](https://github.com/hipeta/arrow-macros/issues/1) problem, but it is edge case, I think)</p>
</del>
